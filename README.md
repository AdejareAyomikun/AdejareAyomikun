...
**[nft-preview-card]** is a **[responsive frontend component]** built with **[HTML, CSS]**. This project demonstrates my ability to **[Build accessible, mobile-responsive layoutss]**. You can check out the repository [here](https://github.com/AdejareAyomikun/nft-preview-card)
